    ...
    return(
      ...
      <Text style={styles.text}>Update Profile</Text>
            ...
            <View style = {{marginTop:25}}>
                ...
                <Text style = {{marginTop:45, marginLeft:40, fontSize:19, fontWeight:'bold'}}>Email  - </Text>
                <Text style = {{marginTop:-25, marginLeft:130, fontSize:17}}>srijandevnath.is19@rvce.edu.in</Text>
                <Text style = {{marginTop:30, marginLeft:40, fontSize:19,fontWeight:'bold'}}>Phone  - </Text>
                <Text style = {{marginTop:-25, marginLeft:130, fontSize:17}}>9711309606</Text>
                <Text style = {{marginTop:30, marginLeft:40, fontSize:19,fontWeight:'bold'}}>College  - </Text>
                <Text style = {{marginTop:-25, marginLeft:140, fontSize:17}}>RV College of Engineering</Text>
                <Text style = {{marginTop:30, marginLeft:40, fontSize:19, fontWeight:'bold'}}>Department  - </Text>
                <Text style = {{marginTop:-25, marginLeft:178, fontSize:17}}>Information Science</Text>
                <Text style = {{marginTop:30, marginLeft:40, fontSize:19,fontWeight:'bold'}}>Year  - </Text>
                <Text style = {{marginTop:-25, marginLeft:110, fontSize:17}}>3rd Year</Text>
            </View>
